...
#recuerda normalizar la entrada. podemos hacer encadenando funciones como "lower" o "upper". (consulta la documentación)
...
else print("Opcion ingresada no es valida intente nuevamente")
